...
<div class="news_update mod_flexicontent_wrapper mod_flexicontent_wrap<?php echo $moduleclass_sfx; ?>" id="mod_flexicontent_news<?php echo $container_id; ?>">
				...
				<?php ob_start(); ?>
					...
					<?php foreach ($item->fields as $k => $field) : ?>
						...
						<div class="field_block field_<?php echo $k; ?>">
							...
							<?php endif; ?>
							<div class="catrtitle" style="color:#666;"><?php echo $field->display; ?></div>
						</div>
					<?php endforeach; ?>
