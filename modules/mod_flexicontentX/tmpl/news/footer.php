	<!--User Defien: a class="btn btn-primary"-->
	<?php
		...
		<a class="btn btn-primary" href="<?php echo JRoute::_($more_link); ?>" <?php if ($params->get('more_blank') == 1) {echo 'target="_blank"';} ?>><span><?php echo JText::_($more_title); ?></span></a>
