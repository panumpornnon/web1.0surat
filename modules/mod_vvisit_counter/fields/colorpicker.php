...
class JFormFieldColorpicker extends JFormField
{
	...
	protected function getInput()
	{
		...
		$doc->addScript($scriptname);
                $doc->addScript(JUri::root(). 'media/mod_vvisit_counter/js/colorpicker.js');
                $doc->addScript(JUri::root(). 'media/mod_vvisit_counter/js/eye.js');
                $doc->addScript(JUri::root(). 'media/mod_vvisit_counter/js/layout.js?ver=1.0.2');
                $doc->addScript(JUri::root(). 'media/mod_vvisit_counter/js/utils.js');
                $doc->addStyleSheet(JUri::root(). 'media/mod_vvisit_counter/css/colorpicker.css');
                $doc->addStyleSheet(JUri::root(). 'media/mod_vvisit_counter/css/layout.css');
...
//';
        ...
        $js = "jQuery(document).ready(function(){jQuery('#".$this->id."').ColorPicker({
