...
class JFormFieldPwebTips extends JFormField
{
    ...
    protected function getInput()
    {
        ...
        $html .= '<div><code>#pwebbox1_toggler</code> <a href="index.php?option=com_menus&view=items" target="_blank">' . JText::_('MOD_PWEBBOX_GO_TO_MENUS') . '</a></div>';
