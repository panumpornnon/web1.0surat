...
class plgSystemCwgearsInstallerScript
{
    ...
    private $removeFiles = array(
        'files' => array('plugins/system/cwgears/script.cwgears.php','media/coalaweb/plugins/system/gears/uikit/js/uikit.js','media/coalaweb/plugins/system/gears/uikit/js/uikit.min.js'
        ),
        'folders' => array(
        )
    );
    ...
    private function renderPostInstallation($status, $parent, $type)
    {
        ...
        <div class="well well-lg">
            ...
            <?php if ($status->gears) : ?>
                <div class="alert alert-danger">
                    <span class="icon-notification"></span>
                    <?php echo JText::_('PLG_CWGEARS_GEARS_CURRENT_NEWER_MSG'); ?>
                </div>
            <?php endif; ?>
            ...
            <table class="coalaweb">
                ...
                <tr class="row0">
                    <td class="key">
                        <?php echo JText::_('PLG_CWGEARS_TITLE_' . $typeUpper . ''); ?>
                    </td>
                    <td>
    ...
    private function renderPostUninstallation($status, $parent)
    {
        ...
        <div class="well well-lg">
            <h3><?php echo JText::_('PLG_CWGEARS_TITLE_' . $typeUpper . '') . ' - ' . JText::_('PLG_CWGEARS_UNINSTALL_STATUS_MSG') ?></h3>
            <table class="coalaweb">
                <thead align="left">
                <tr>
                    <th class="title" align="left">Main</th>
