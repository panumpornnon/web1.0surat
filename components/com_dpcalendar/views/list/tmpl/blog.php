...
$this->dpdocument->loadStyleFile('dpcalendar/views/list/blog.css');
$this->dpdocument->loadScriptFile('dpcalendar/views/list/default.js');
?>
<div class="com-dpcalendar-blog dp-locations<?php echo $this->pageclass_sfx ? ' com-dpcalendar-blog-' . $this->pageclass_sfx : ''; ?>">
