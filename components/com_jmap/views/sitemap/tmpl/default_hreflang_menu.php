...
$alternateLink = htmlspecialchars(JRoute::_ ( 'index.php?Itemid=' . $alternate->id . '&lang=' . $alternate->sef ), ENT_NOQUOTES, 'UTF-8', false);
...
<?php
		foreach ($associatedMenus as $repetition) {
			...
			$repetitionLink = htmlspecialchars(JRoute::_ ( 'index.php?Itemid=' . $repetition->id . '&lang=' . $repetition->sef ), ENT_NOQUOTES, 'UTF-8', false);
...
$alternateLink = htmlspecialchars(JRoute::_ ( 'index.php?Itemid=' . $subalternate->id . '&lang=' . $subalternate->sef ), ENT_NOQUOTES, 'UTF-8', false);
$alternateLink = preg_match('/^http/i', $alternateLink) ? $alternateLink : $this->liveSite . (strpos($alternateLink, '/') === 0 ? $alternateLink : '/'.$alternateLink);
?>
