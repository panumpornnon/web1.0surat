...
<?php echo '<'.$mainAreaTag; ?> id="flexicontent" class="<?php echo $page_classes; ?>" <?php echo $microdata_itemtype_code; ?>>
  ...
  <?php if ($item->event->afterDisplayTitle) : ?>
	...
	<?php
		$show_vote = $this->params->get('show_vote', 0) && FlexicontentFields::getFieldDisplay($item, 'voting', $values=null, $method='display');
		$show_favs = $this->params->get('show_favs', 0) && FlexicontentFields::getFieldDisplay($item, 'favourites', $values=null, $method='display');
	?>
