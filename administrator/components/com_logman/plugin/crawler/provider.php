...
/**
 * Plugin crawler provider
 *
 * Data from Crawler Detect v1.2.88 <https://github.com/JayBizzle/Crawler-Detect> (c) Mark Beech <m@rkbee.ch>
 *
 * @author  Arunas Mazeika <https://github.com/amazeika>
 * @package Joomlatools\Component\LOGman
 */

class ComLogmanPluginCrawlerProvider extends KObject
{
    /**
    ...
    /**
     * Compiled data getter
     *
     * Compiles a regular expression from data
     *
     * @param string $name The name of the property containing data
     * @return bool|string The compiled regular expression, false if no data is found for the given property name
     */
    public function getCompiled($name)
    {
        $compiled = false;

        if ($data = $this->getData($name)) {
            $compiled = sprintf('(%s)', implode('|', $data));
        }
     ...
     *
     * @param string $name The name of the property containing data
     * @return bool|string The data, false if no data is found for the given property name
     */
    public function getData($name)
    {
        $data = false;

        $property = sprintf('_%s', strtolower($name));
