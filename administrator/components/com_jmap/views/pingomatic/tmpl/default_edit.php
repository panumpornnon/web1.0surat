				...
				<tbody>
					...
					<tr>
						...
						<td class="right_details">
							...
							<?php else:?>
								<label class="label label-warning" id="lastping"><?php echo JText::_('COM_JMAP_NEVER_PING');?></label>
							<?php endif;?>
						</td>
					</tr> 
				</tbody>
							...
							<div class="panel panel-success">
								...
								<div class="panel-body">
								    <div id="common">
										...
										<div class="service_control"><fieldset class="radio btn-group"><?php echo $this->lists['ajs_indexnowbing'];?></fieldset><a href="https://www.indexnow.org" target="_blank"><label class="as label label-info">IndexNow Bing</label></a></div>
										<div class="service_control"><fieldset class="radio btn-group"><?php echo $this->lists['ajs_indexnowyandex'];?></fieldset><a href="https://www.indexnow.org" target="_blank"><label class="as label label-info">IndexNow Yandex</label></a></div>
									</div>
								</div>
							</div>
							<div class="panel panel-success">
