						...
						<div class="panel-body">
							...
							<div class="single_container">
				 			...
				 			<div class="single_container xmlcontainer">
						 		...
						 		<?php 
						 			...
						 			$concatenatePingXmlFormat .= "<a data-role='pinger' data-type='rpc' class='pinger glyphicon glyphicon-flash' href='https://www.bing.com/indexnow?key=28bcb027f9b443719ceac7cd30556c3c&url=" . rawurlencode($this->livesite . '/index.php?option=com_jmap&view=sitemap&format=xml') . "'>" . JText::_('COM_JMAP_PING_BING') . "</a>";
					 		...
					 		<div class="single_container xmlcontainer">
						 		...
						 		<?php 
						 			...
						 			$concatenatePingXmlFormat .= "<a data-role='pinger' data-type='rpc' class='pinger glyphicon glyphicon-flash' href='https://www.bing.com/indexnow?key=28bcb027f9b443719ceac7cd30556c3c&url=" . rawurlencode($this->livesite . '/index.php?option=com_jmap&view=sitemap&format=images') . "'>" . JText::_('COM_JMAP_PING_BING') . "</a>";
					 		...
					 		<div class="single_container xmlcontainer">
						 		...
						 		<?php 
						 			...
						 			$concatenatePingXmlFormat .= "<a data-role='pinger' data-type='rpc' class='pinger glyphicon glyphicon-flash' href='https://www.bing.com/indexnow?key=28bcb027f9b443719ceac7cd30556c3c&url=" . rawurlencode($this->livesite . '/index.php?option=com_jmap&view=sitemap&format=gnews') . "'>" . JText::_('COM_JMAP_PING_BING') . "</a>";
					 		...
					 		<div class="single_container xmlcontainer">
						 		...
						 		<?php 
						 			...
						 			$concatenatePingXmlFormat .= "<a data-role='pinger' data-type='rpc' class='pinger glyphicon glyphicon-flash' href='https://www.bing.com/indexnow?key=28bcb027f9b443719ceac7cd30556c3c&url=" . rawurlencode($this->livesite . '/index.php?option=com_jmap&view=sitemap&format=mobile') . "'>" . JText::_('COM_JMAP_PING_BING') . "</a>";
					 		...
					 		<div class="single_container xmlcontainer">
						 		...
						 		<?php 
						 			...
						 			$concatenatePingXmlFormat .= "<a data-role='pinger' data-type='rpc' class='pinger glyphicon glyphicon-flash' href='https://www.bing.com/indexnow?key=28bcb027f9b443719ceac7cd30556c3c&url=" . rawurlencode($this->livesite . '/index.php?option=com_jmap&view=sitemap&format=videos') . "'>" . JText::_('COM_JMAP_PING_BING') . "</a>";
							...
							<div class="single_container xmlcontainer">
						 		...
						 		<?php 
						 			...
						 			$concatenatePingXmlFormat .= "<a data-role='pinger' data-type='rpc' class='pinger glyphicon glyphicon-flash' href='https://www.bing.com/indexnow?key=28bcb027f9b443719ceac7cd30556c3c&url=" . rawurlencode($this->livesite . '/index.php?option=com_jmap&view=sitemap&format=hreflang') . "'>" . JText::_('COM_JMAP_PING_BING') . "</a>";
					 		...
					 		<div class="single_container xmlcontainer">
						 		...
						 		<?php 
						 			...
						 			$concatenatePingXmlFormat .= "<a data-role='pinger' data-type='rpc' class='pinger glyphicon glyphicon-flash' href='https://www.bing.com/indexnow?key=28bcb027f9b443719ceac7cd30556c3c&url=" . rawurlencode($this->livesite . '/index.php?option=com_jmap&view=sitemap&format=amp') . "'>" . JText::_('COM_JMAP_PING_BING') . "</a>";
					 		...
					 		<div class="single_container xmlcontainer">
						 		...
						 		<?php 
						 			...
						 			$concatenatePingXmlFormat .= "<a data-role='pinger' data-type='rpc' class='pinger glyphicon glyphicon-flash' href='https://www.bing.com/indexnow?key=28bcb027f9b443719ceac7cd30556c3c&url=" . rawurlencode($this->livesite . '/index.php?option=com_jmap&view=geositemap&format=xml') . "'>" . JText::_('COM_JMAP_PING_BING') . "</a>";
