...
class JMapViewMetainfo extends JMapView {
	...
	public function display($tpl = 'list') {
		...
		$doc->addScriptDeclaration("var jmap_metainfoAutopopulateSocialimageSelector='" . addcslashes(trim($this->getModel()->getComponentParams()->get('metainfo_autopopulate_socialimage_selector', '')), "'") . "';");
		$doc->addScriptDeclaration("var jmap_metainfoAutoGenerateMetadescription=" . $this->getModel()->getComponentParams()->get('metainfo_auto_generate_metadescription', 0) . ";");
		$doc->addScriptDeclaration("var jmap_metainfoAutoGenerateMetadescriptionCssSelector='" . addcslashes(trim($this->getModel()->getComponentParams()->get('metainfo_auto_generate_metadescription_css_selector', 'div[itemprop=articleBody],div.item-page')), "'") . "';");
		$doc->addScriptDeclaration("var jmap_metainfoAutoGenerateMetadescriptionMaxLength=" . $this->getModel()->getComponentParams()->get('metainfo_auto_generate_metadescription_max_length', 155) . ";");
