...
<form action="index.php" method="post" name="adminForm" id="adminForm" class="jmap-pagespeed">
	<div class="pagespeed-pagelink">
		...
		<span data-content="<?php echo JText::_('COM_JMAP_GOOGLE_PAGESPEED_REPORT_STRATEGY');?>" class='label label-primary hasLeftPopover pull-right'>
			<?php echo $strategy == 'desktop' ? JText::_('COM_JMAP_GOOGLE_PAGESPEED_REPORT_STRATEGY_DESKTOP') : JText::_('COM_JMAP_GOOGLE_PAGESPEED_REPORT_STRATEGY_MOBILE');?>
		</span>
	</div>
			...
			<table class="adminlist table table-striped table-hover">
				...
				<tbody>
					...
					<tr>
						...
						<td class="align-center hidden-phone" style="vertical-align: middle">
							<div>
			...
			<table class="adminlist table table-striped table-hover table-centered">
				<thead>
					<tr>
						<th class="title corewebvitals">
							<a href="https://web.dev/lcp/" target="_blank" class="hasTooltip" title="<?php echo JText::_('COM_JMAP_GOOGLE_PAGESPEED_PERFORMANCE_REPORT_WEBVITALS');?>">
								<?php echo JText::_('COM_JMAP_GOOGLE_PAGESPEED_REPORT_LCP' ); ?>
							</a>
						</th>
						<th class="title corewebvitals">
							<a href="https://web.dev/cls/" target="_blank" class="hasTooltip" title="<?php echo JText::_('COM_JMAP_GOOGLE_PAGESPEED_PERFORMANCE_REPORT_WEBVITALS');?>">
								<?php echo JText::_('COM_JMAP_GOOGLE_PAGESPEED_REPORT_CLS' ); ?>
							</a>
						</th>
						<?php if(isset($this->googleData['loadingExperience']['metrics'])):?>
							<th class="title title-widthed corewebvitals">
								<a href="https://web.dev/fid/" target="_blank" class="hasTooltip" title="<?php echo JText::_('COM_JMAP_GOOGLE_PAGESPEED_PERFORMANCE_REPORT_WEBVITALS');?>">
						...
						<?php if(isset($this->googleData['lighthouseResult']['audits'])):?>
							...
							<th class="title hidden-phone hidden-tablet hidden-smalldesktop">
				...
				<tbody>
					<tr>
						...
						?>
						<td>
							<span data-content="<?php echo JText::_('COM_JMAP_GOOGLE_PAGESPEED_REPORT_LCP_DESC');?>" class="hasPopover label label-primary"><?php echo $lcpValue; ?> s</span>
							<span data-content="<?php echo JText::_('COM_JMAP_GOOGLE_PAGESPEED_REPORT_LCP_DESC');?>" class="hasPopover label label<?php echo $arrayLabels[$lcpScoreVote];?> label-score"><?php echo $lcpScoreVote; ?></span>
						</td>
						<td>
							<span data-content="<?php echo JText::_('COM_JMAP_GOOGLE_PAGESPEED_REPORT_CLS_DESC');?>" class="hasPopover label label-primary"><?php echo $clsValue; ?></span>
							<span data-content="<?php echo JText::_('COM_JMAP_GOOGLE_PAGESPEED_REPORT_CLS_DESC');?>" class="hasPopover label label<?php echo $arrayLabels[$clsScoreVote];?> label-score"><?php echo $clsScoreVote; ?></span>
						</td>
						<?php if(isset($this->googleData['loadingExperience']['metrics'])):?>
							<td>
						...
						<?php if(isset($this->googleData['lighthouseResult']['audits'])):?>
							...
							<td class="hidden-phone hidden-tablet">
								<span data-content="<?php echo JText::_('COM_JMAP_GOOGLE_PAGESPEED_REPORT_FCI_DESC');?>" class="hasPopover label label-primary"><?php echo $this->googleData['lighthouseResult']['audits']['server-response-time']['displayValue'];?></span>
							</td>
							<td class="hidden-phone">
							...
							<td class="hidden-phone hidden-tablet hidden-smalldesktop">
								<span data-content="<?php echo JText::_('COM_JMAP_GOOGLE_PAGESPEED_REPORT_MPFID_DESC');?>" class="hasPopover label label-primary"><?php echo $this->googleData['lighthouseResult']['audits']['max-potential-fid']['displayValue'];?></span>
							</td>
							<td class="hidden-phone hidden-tablet hidden-smalldesktop">
