	...
	<tbody>
		<tr>
			...
			<?php if(isset($this->googleData['lighthouseResult']['audits'])):?>
				...
				<td>
					<span data-content="<?php echo JText::_('COM_JMAP_GOOGLE_PAGESPEED_REPORT_FCI_DESC');?>"><?php echo $this->googleData['lighthouseResult']['audits']['server-response-time']['displayValue'];?></span>
				</td>
				<td>
				...
				<td>
					<span data-content="<?php echo JText::_('COM_JMAP_GOOGLE_PAGESPEED_REPORT_MPFID_DESC');?>"><?php echo $this->googleData['lighthouseResult']['audits']['max-potential-fid']['displayValue'];?></span>
				</td>
				<td>
