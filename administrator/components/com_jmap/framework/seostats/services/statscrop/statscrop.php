<?php
// namespace administrator\components\com_jmap\framework\seostats\services\statscrop;
/**
 *
 ...
 * @since 3.0
 */
class JMapSeostatsServicesStatscrop extends JMapSeostatsServicesBase {
	/**
	 * Used for cache
	 * 
	 * @access protected 
	...
	protected static function _getStatsPage($url) {
		...
		$dataUrl = sprintf ( JMapSeostatsServices::$STATSCROP_SITEINFO_URL, $domain );
	...
	public static function getRating($url = false) {
		...
		return $stringRankValue . '/5<span class="seostats_unit_measure_small">' . JText::_('COM_JMAP_STATSCROP_RATING_STARS') . '</span>';
	}
	...
	public static function getBacklinkers($url = false) {
		...
		$queryList = array (
				"//div[@id='site-referrals-backward-links']//div[@class='table-responsive']//tr/td[1]"
		);
