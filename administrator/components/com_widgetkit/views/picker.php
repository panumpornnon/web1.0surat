<div class="uk-scope" ng-controller="pickerCtrl as vm" ng-switch="vm.view">
    <div ng-switch-when="content">
        ...
        <div ng-if="loaded">
            ...
            <div class="uk-modal-footer uk-text-right">
                <button class="uk-button uk-button-default" type="button" ng-click="vm.cancel()">{{'Close' | trans}}</button>
            </div>
