...
.install-not-ok {
	...
	<div>
		...
		<p><img src="<?php echo \Joomla\CMS\Uri\Uri::root(true) . '/media/com_rsfirewall/images/rsfirewall-box.png'; ?>" alt="RSFirewall!" /></p>
			...
			<h2>Changelog v3.1.2</h2>
			<ul class="version-history">
                <li><span class="version-fixed">Fix</span> In some cases the generated php.ini contents would overflow the page during the System Check scan.</li>
                <li><span class="version-fixed">Fix</span> Joomla! 5.1 Dark Mode fixes.</li>
                <li><span class="version-fixed">Fix</span> In Joomla! 5.1 a class naming collision resulted in Exceptions not being able to be saved showing a message about valid Regex.</li>
                <li><span class="version-fixed">Fix</span> When using Country Blocking, in some cases the IP's country was cached until a new session was started.</li>
			</ul>
			<?php
			if ($type === 'install')
			{
