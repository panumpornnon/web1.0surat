...
<?php if (!$this->config->get('active_scanner_status')) { ?>
	<div class="com-rsfirewall-not-ok"><p><?php echo Text::_('COM_RSFIREWALL_ACTIVE_SCANNER_IS_DISABLED'); ?></p></div>
<?php } else { ?>
	<div class="com-rsfirewall-ok"><p><?php echo Text::_('COM_RSFIREWALL_ACTIVE_SCANNER_IS_ENABLED'); ?></p></div>
<?php } ?>
<?php
