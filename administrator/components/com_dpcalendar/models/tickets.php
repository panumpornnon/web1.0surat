...
class DPCalendarModelTickets extends JModelList
{
	...
	protected function getListQuery()
	{
		...
		$query->select('e.catid AS event_calid, e.title as event_title, e.start_date, e.end_date, e.all_day, e.show_end_time, e.price as event_prices, e.booking_options as event_options');
