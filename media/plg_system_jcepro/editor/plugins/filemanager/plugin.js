...
!function() {
    ...
    tinymce.PluginManager.add("filemanager", function(ed, url) {
        ...
        ed.addCommand("mceFileManager", function() {
            ...
            var cm, form, urlCtrl, textCtrl, targetCtrl, formatCtrl, heightCtrl, sizeCtrl, args, attribs, mediaApi = ed.plugins.media, params = ed.getParam("filemanager", {});
            ...
            }), form.add(textCtrl), args = cm.createTextBox("filemanager_title", {
                label: ed.getLang("filemanager.title", "Title"),
                name: "title",
                clear: !0
            }), form.add(args), targetCtrl = cm.createListBox("filemanager_target", {
