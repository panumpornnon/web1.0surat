...
!function() {
    ...
    tinymce.PluginManager.add("templatemanager", function(ed, url) {
        ...
        ed.addCommand("mceTemplate", function(ui) {
            ...
            return function(args) {
                var html = function(html) {
                    ...
                    }), html = trimHtml(html), (replace_values = document.implementation.createHTMLDocument("").body).innerHTML = html, 
        ...
        content_url && ed.onInit.add(function() {
            ...
            if (data && data.filetypes && new RegExp(".(" + data.filetypes.join("|") + ")$", "i").test(o.name)) return o.data && (data = trimHtml(o.data)) && ed.execCommand("mceInsertTemplate", !1, {
                content: data
            }), !0;
            return !1;
