    ...
    tinymce.PluginManager.add("imgmanager_ext", function(ed, url) {
        ...
        ed.addCommand("mceImageManagerExtended", function() {
            ...
            ed.onUpdateMedia.add(function(ed, o) {
                var stamp, src;
                if (o.node) return !(src = (o = o.node).getAttribute("src")) || -1 !== src.indexOf("?") || !/\.(jpg|jpeg|png|gif|webp|avif)$/.test(src) || (stamp = "?v=" + new Date().getTime(), 
                src = ed.convertURL(src, "src", o.nodeName), o.setAttribute("src", src + stamp), 
                void o.setAttribute("data-mce-src", src));
            });
            var cm, form, urlCtrl, captionCtrl, descriptionCtrl, args, uploader, stylesListCtrl, params = ed.getParam("imgmanager_ext", {});
